                          ...
                          <div class="cart" style="width: 18rem;">
                            <img src="<?= $film['poster'] ?>" class="card-img-top"  alt="...">
                              <div class="card-body">
                                ...
                                <p class="card-text"><?= $film['age restrictions'] ?></p>
                                <p class="card-text"><?= $film['paragraph'] ?></p>
                                <p class="card-text"><?= $film['country'] ?></p>
                                <p class="card-text"><?= $film['genre'] ?></p>
                                <p class="card-text"><?= $film['production year'] ?></p>
                                <p class="card-text"><?= $film['budget'] ?></p>
                                <a class="card-text"><?= $film['trailer'] ?></a>
                              </div>
                          </div>
        </div>
       <?php endforeach; ?>
